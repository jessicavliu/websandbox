...
p_lightblue = Product("light blue", "ADD8E6", c_blue)	
p_skyblue = Product("sky blue", "87CEEB", c_blue)
p_lightskyblue=Product("light sky blue", "87CEFA", c_blue)	
p_deepskyblue=Product("deep sky blue", "00BFFF", c_blue)
p_dodgerblue = Product("dodger blue", "1E90FF", c_blue)
p_cornflowerblue = Product("corn flower blue", "6495ED", c_blue)	
p_steelblue=Product("steel blue", "4682B4", c_blue)
p_royalblue = Product("royal blue", "4169E1", c_blue)
p_blue = Product("blue", "0000FF", c_blue)
p_mediumblue = Product("medium blue", "0000CD", c_blue)  
p_darkblue = Product("dark blue", "00008B", c_blue)
p_navy = Product("navy", "000080", c_blue)
p_midnightblue = Product("midnight blue", "191970", c_blue)	 
...
#--
#putting all prods and cats into dicts to delete them all. Then reinsert using dict way.
#deletable and pink are already in dicts.

prod_dict_green = {}
dict_list = [('p_darkolivegreen', p_darkolivegreen), ('p_olive', p_olive), ('p_olivedrab', p_olivedrab), ('p_yellowgreen', p_yellowgreen), ('p_limegreen', p_limegreen), ('p_lime', p_lime), ('p_lawngreen', p_lawngreen), ('p_chartreuse', p_chartreuse), ('p_greenyellow', p_greenyellow), ('p_springgreen', p_springgreen), ('p_mediumspringgreen', p_mediumspringgreen), ('p_lightgreen', p_lightgreen), ('p_palegreen', p_palegreen), ('p_darkseagreen', p_darkseagreen), ('p_mediumaquamarine', p_mediumaquamarine), ('p_mediumseagreen', p_mediumseagreen), ('p_seagreen', p_seagreen), ('p_forestgreen', p_forestgreen), ('p_green', p_green), ('p_darkgreen', p_darkgreen)]

for d in dict_list:
	prod_dict_green[d[0]] = d[1]

del dict_list

prod_dict_blue = {}
dict_list = [('p_lightsteelblue', p_lightsteelblue), ('p_powderblue', p_powderblue), ('p_lightblue', p_lightblue), ('p_skyblue', p_skyblue), ('p_lightskyblue', p_lightskyblue), ('p_deepskyblue', p_deepskyblue), ('p_dodgerblue', p_dodgerblue), ('p_cornflowerblue', p_cornflowerblue), ('p_steelblue', p_steelblue), ('p_royalblue', p_royalblue), ('p_blue', p_blue), ('p_mediumblue', p_mediumblue), ('p_darkblue', p_darkblue), ('p_navy', p_navy), ('p_midnightblue', p_midnightblue)]	

for d in dict_list:
	prod_dict_blue[d[0]] = d[1]

del dict_list

prod_dict_cyan = {}
dict_list = [('p_aqua', p_aqua), ('p_cyan', p_cyan), ('p_lightcyan', p_lightcyan), ('p_paleturquoise',p_paleturquoise), ('p_aquamarine', p_aquamarine), ('p_turquoise', p_turquoise), ('p_mediumturquoise', p_mediumturquoise), ('p_darkturquoise', p_darkturquoise), ('p_lightseagreen', p_lightseagreen), ('p_cadetblue', p_cadetblue), ('p_darkcyan', p_darkcyan), ('p_teal', p_teal)]

for d in dict_list:
	prod_dict_cyan[d[0]] = d[1]
del dict_list

'''list_prod_dicts = [prod_dict, prod_dict_pink, prod_dict_green, prod_dict_blue, prod_dict_cyan]
for d in list_prod_dicts:
	for p in d:
		prodset.delete_product(d[p])'''

cat_dict = {}
cat_list = [('c_pink', c_pink), ('c_green', c_green), ('c_purple', c_purple), ('c_red', c_red), ('c_orange', c_orange), ('c_yellow', c_yellow), ('c_white', c_white), ('c_brown', c_brown), ('c_grayblack', c_grayblack), ('c_blue', c_blue), ('c_cyan', c_cyan)]
for c in cat_list:
	cat_dict[c[0]] = c[1]
