...
def mass_delete_cats(cat_dict):
	for c in cat_dict:
		catset.delete_category(cat_dict[c])
...
path = "/Users/jessicaliu/Dropbox (MIT)/Classes/2016/1Summer/EIT UROP/websandbox/sample-prods.xlsx"
